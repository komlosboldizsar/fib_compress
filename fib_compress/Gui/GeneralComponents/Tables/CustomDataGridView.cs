...
namespace fib_compress.Gui.GeneralComponents.Tables
{
    public class CustomDataGridView<T>: DataGridView
    {

        private IObservableCollection<T> boundCollection;

        public IObservableCollection<T> BoundCollection
        {
        ...
        public CustomDataGridView(IObservableCollection<T> boundCollection)
        {
